...
CFG=yazclient - Win32 Debug URSULA
...
!MESSAGE 
!MESSAGE NMAKE /f "yazclient.mak" CFG="yazclient - Win32 Debug URSULA"
!MESSAGE 
...
!MESSAGE "yazclient - Win32 Debug URSULA" (based on "Win32 (x86) Console Application")
!MESSAGE "yazclient - Win32 Release URSULA" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "../../include" /I "../../../yaz/include" /I "../../../yaz-ursula/include" /D "_CONSOLE" /D "_MBCS" /D "WIN32" /D "_DEBUG" /D HAVE_YAZ_URSULA_H=0 /FR /YX /FD /c
...
!ELSEIF  "$(CFG)" == "yazclient - Win32 Debug URSULA"

# PROP BASE Use_MFC 0
# PROP BASE Use_Debug_Libraries 1
# PROP BASE Output_Dir "yazclient___Win32_Debug_URSULA"
# PROP BASE Intermediate_Dir "yazclient___Win32_Debug_URSULA"
# PROP BASE Ignore_Export_Lib 0
# PROP BASE Target_Dir ""
# PROP Use_MFC 0
# PROP Use_Debug_Libraries 1
# PROP Output_Dir "yazclient___Win32_Debug_URSULA"
# PROP Intermediate_Dir "yazclient___Win32_Debug_URSULA"
# PROP Ignore_Export_Lib 0
# PROP Target_Dir ""
# ADD BASE CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "../../include" /I "../../../yaz/include" /I "../../../yaz-ursula/include" /D "_CONSOLE" /D "_MBCS" /D "WIN32" /D "_DEBUG" /D HAVE_YAZ_URSULA_H=1 /FR /YX /FD /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib yazxx.lib yaz.lib wsock32.lib ursula.lib /nologo /subsystem:console /debug /machine:I386 /out:"Debug/yazmyclient.exe" /pdbtype:sept /libpath:"../yazxx/debug" /libpath:"../../../yaz/lib" /libpath:"../../../yaz-ursula/win/debug" /libpath:"../../../yaz-ursula/win"
# Begin Special Build Tool
OutDir=.\yazclient___Win32_Debug_URSULA
ProjDir=.
TargetName=yazmyclient
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\$(TargetName).exe $(ProjDir)\..\..\..\bin
...
!ELSEIF  "$(CFG)" == "yazclient - Win32 Release URSULA"

# PROP BASE Use_MFC 0
# PROP BASE Use_Debug_Libraries 0
# PROP BASE Output_Dir "yazclient___Win32_Release_URSULA"
# PROP BASE Intermediate_Dir "yazclient___Win32_Release_URSULA"
# PROP BASE Ignore_Export_Lib 0
# PROP BASE Target_Dir ""
# PROP Use_MFC 0
# PROP Use_Debug_Libraries 0
# PROP Output_Dir "yazclient___Win32_Release_URSULA"
# PROP Intermediate_Dir "yazclient___Win32_Release_URSULA"
# PROP Ignore_Export_Lib 0
# PROP Target_Dir ""
# ADD BASE CPP /nologo /MD /W3 /GX /O2 /I "../../include" /I "../../../yaz/include" /I "../../../yaz-ursula/include" /D "_CONSOLE" /D "_MBCS" /D "WIN32" /D "NDEBUG" /D HAVE_YAZ_URSULA_H=1 /YX /FD /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib yazxx.lib yaz.lib wsock32.lib ursula.lib /nologo /subsystem:console /machine:I386 /out:"Release/yazmyclient.exe" /libpath:"../yazxx/release" /libpath:"../../../yaz/lib" /libpath:"../../../yaz-ursula/win/release"
# Begin Special Build Tool
OutDir=.\yazclient___Win32_Release_URSULA
ProjDir=.
TargetName=yazmyclient
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\$(TargetName).exe $(ProjDir)\..\..\..\bin
...
# Name "yazclient - Win32 Debug URSULA"
# Name "yazclient - Win32 Release URSULA"
# Begin Source File
